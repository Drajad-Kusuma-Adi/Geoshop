...
<body>
    ...
    <main>
        ...
        <div class="container p-4 rounded" style="background-color: #F6F4EB; text-align: center;">
            ...
            <br>
            <form action="../php/modifyProduct.php?productImage=<?php if (isset($_GET["tempImage"]) && file_exists($_GET["tempImage"])) {
                                                                    echo $_GET["tempImage"];
                                                                } ?>" method="POST" enctype='multipart/form-data'>
                <div class="form-group mb-3">
                    <label class="fs-5" for="productName">Product name:</label>
                    <input required class="form-control" type="text" name="productName" id="productName" value="<?php echo $productName; ?>">
                </div>
                <br>
                <div class="form-group mb-3">
                    <label class="fs-5" for="productDescription">Description:</label>
                    <textarea class="form-control" name="productDescription" id="productDescription" style="height: 20vw; resize: none;">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input required class="form-control" type="number" name="productPrice" id="productPrice" value="<?php echo $price; ?>">
                    </div>
                </div>
                <div class="form-group mb-3">
                    <label class="fs-5" for="productStock">Current stock:</label>
                    <input required class="form-control" type="number" name="productStock" id="productStock" value="<?php echo $stock; ?>">
                </div>
                <br>
