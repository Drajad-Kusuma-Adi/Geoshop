    ...
    <div id="mainContainer">
        ...
        <main>
            <div id="loginContainer" align="center">
                <form method="post" action="../service/login.php">
                    <div>
                        ...
                        <input type="email" id="email" name="email" required placeholder="example@example.com" class="input">
                    </div>
                    <br>
                    <div>
                        <label for="password"><h3><b><i class="fa-solid fa-key" style="color: #000000;"></i> Password </b><h3></label>
                        <input type="password" id="password" name="password" placeholder="Enter your account password" required class="input">
                    </div>
                    <br>
            ...
            <div id="loginErrorMessage">
                <p><i class="fa-solid fa-triangle-exclamation" style="color: #000000;"></i> Invalid email or password</p>
            </div>
        </main>
    </div>
