...
<body>
    <div id="mainContainer">
        ...
        <main>
            ...
            <div id="confirmPasswordErrorMessage">
                <p><i class="fa-solid fa-triangle-exclamation" style="color: #000000;"></i> Password and confirm password does not match, please try again</p>
            </div>
        </main>
    </div>
